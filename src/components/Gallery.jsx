  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-3 gap-4">
        ...
        />
        <img
          src="public/images/gallery8.jpg"
          alt="Gallery 8"
          className="max-w-full h-auto"
        />
        <img
          src="public/images/gallery9.jpg"
          alt="Gallery 9"
          className="max-w-full h-auto"
        />
        <img
          src="public/images/gallery10.jpg"
          alt="Gallery 10"
          className="max-w-full h-auto"
        />
        <img
          src="public/images/gallery11.jpg"
          alt="Gallery 11"
          className="max-w-full h-auto"
        />
        <img
          src="public/images/gallery12.jpg"
          alt="Gallery 12"
          className="max-w-full h-auto"
        />
        <img
          src="public/images/gallery13.jpg"
          alt="Gallery 13"
          className="max-w-full h-auto"
        />
        <img
          src="public/images/gallery14.jpg"
          alt="Gallery 14"
          className="max-w-full h-auto"
        />
        <img
          src="public/images/gallery15.jpg"
          alt="Gallery 14"
          className="max-w-full h-auto"
        />
      </div>
